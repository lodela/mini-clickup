...
**Status:** FASE 0-2 Completada → Construyendo FASE 3-7
...
| 02  | [02_Estado_Real_Actual.md](./02_Estado_Real_Actual.md)           | **Estado real del proyecto — audit completo 2026-05-06**           | ✅ Actualizado |
| 10  | [10_Roadmap_y_Deuda_Tecnica.md](./10_Roadmap_y_Deuda_Tecnica.md) | **Roadmap y deuda técnica — bugs + TD-001 a TD-010**               | ✅ Actualizado |
| 11  | [11_Sprint_Plan.md](./11_Sprint_Plan.md)                         | Sprint plan S0–S8 (ampliado con Sprints 6-8 Agile)                 | ✅ Activo      |
| 12  | [12_MVP_Work_Plan.md](./12_MVP_Work_Plan.md)                     | Plan de trabajo MVP (referencia histórica)                         | ✅ Activo      |
| 13  | [13_Roadmap_Rescate_MVP.md](./13_Roadmap_Rescate_MVP.md)         | **Roadmap de rescate — 7 fases, 43 épicas, FASE 6-7 agregadas**    | ✅ Actualizado |
| 14  | [14_Epicas_y_Criterios.md](./14_Epicas_y_Criterios.md)           | **Épicas y criterios — 33 épicas, 52 stories, FASE 6-7 agregadas** | ✅ Actualizado |
